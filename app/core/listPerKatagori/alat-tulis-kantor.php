...
$tampil = tampil("SELECT inventaris.*, katagori.katagori as nama_katagori FROM inventaris INNER JOIN katagori ON inventaris.id_katagori = katagori.id_katagori WHERE inventaris.id_katagori = 3");
$total = 0;
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Daftar Inventaris ATK</title>
