...
$tampil = tampil("SELECT inventaris.*, katagori.katagori as nama_katagori FROM inventaris INNER JOIN katagori ON inventaris.id_katagori = katagori.id_katagori WHERE inventaris.id_katagori = 1");
//var_dump($tampil); die;
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Daftar Inventaris Bangunan</title>
    ...
    <body>
        ...
        ?>
         <h3>Daftar Inventaris Bangunan</h3>
